            ...
            <v-flex xs12 sm6 offset-sm3>
                <v-card color="secondary" dark>
                    <v-container grid-list-xs>
                        <v-form @submit.prevent="handleSignInUser" v-model="isFormValid"
                            ...
                            <v-layout row wrap>
                                <v-flex xs12>
                                    <v-text-field :rules="getPasswordRules" v-model="password"
                                      ...
                                      prepend-icon="mdi-puzzle" type="password" required>
                                    </v-text-field>
                                </v-flex>
                            </v-layout>
                            <v-layout row>
                                <v-flex xs12 text-center>
                                    <v-btn :disabled="!isFormValid || loading"
                                      :loading="loading" type="submit" color="accent"
                                      tile depressed>
                                        SignIn
...
export default class SignIn extends Vue {
    ...
    public actSignInUser!: (signUserData: SignInUser) => Promise<boolean | Error> ;
